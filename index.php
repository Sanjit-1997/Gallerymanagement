   ...
   <body>
                     ...
                     <div class="slider-img two-img">
                        <div class="container">
                           <div class="slider-info ">
                              ...
                              <div class="bottom-info">
                                 <p>This is right time to show your potential</p>
                              </div>
                              <div class="outs_more-buttn">
                                 <a href="about.php">Read More</a>
                              </div>
      ...
      <section class="blog py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">AVAILABLE PRODUCT</h3>
            <div class="slid-img">
               <ul id="flexiselDemo1">
                  <?php
...
?>
                  <li>
                     ...
                     <div class="agileinfo_port_grid">
                        ...
                        <div class="outs_more-buttn">
                           <a href="art-enquiry.php?eid=<?php echo $row['apid'];?>">CLICK TO ORDER</a>
                        </div>
                     </div>
                  </li><?php }?>
